...
public class MultiSplitPane extends JPanel {
    private AccessibleContext _accessibleContext = null;
    ...
    private void startDrag( int mx, int my ) {
        ...
        if ( divider != null ) {
            ...
            if ( prevNode == null || nextNode == null ) {
                ...
                oldFloatingDividers = getMultiSplitLayout().hasFloatingDividers();
    ...
    public AccessibleContext getAccessibleContext() {
        if ( _accessibleContext == null ) {
            _accessibleContext = new AccessibleMultiSplitPane();
        }
