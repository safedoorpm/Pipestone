...
public class GoldenRatioLayoutManager implements LayoutManager {
    ...
    /**
     The {@link MessageProxy} instance provided when this instance was created (<code>null</code> if no
     {@link MessageProxy} instance was provided).
     */
    ...
    public void removeLayoutComponent( final Component component ) {
        ...
        logMsg( "GoldenRatioLayoutManager.removeLayoutComponent( " +
                GoldenRatioLayoutManager.getComponentName( component ) +
                " )" );
    ...
    /**
     ...
     <p/>This implementation simply returns the value returned when passing the specified container to this instance's
     {@link GoldenRatioLayoutManager#minimumLayoutSize} method.
    ...
    /**
     ...
     <li>Alternatively, if the largest <i>golden rectangle</i> that fits is vertically oriented then it is centered
     horizontally
    ...
    public void layoutContainer( final Container container ) {
        ...
        Insets insets = container.getInsets();
        @SuppressWarnings("UnnecessaryLocalVariable") int originalAvailableWidth =
                container.getWidth() - ( insets.left + insets.right );
        int availableWidth = originalAvailableWidth;
        @SuppressWarnings("UnnecessaryLocalVariable") int originalAvailableHeight =
                container.getHeight() - ( insets.top + insets.bottom );
        int availableHeight = originalAvailableHeight;

        logMsg(
                "GoldenRatioLayoutManager.layoutContainer( " +
                GoldenRatioLayoutManager.getComponentName( container ) +
                " ):  " +
    ...
    private int adjustWidth(
        ...
        int newAvailableWidth = horizontal ?
                (int)Math.round( availableHeight * GoldenRatioLayoutManager.GOLDEN_RATIO ) :
                (int)Math.round( availableHeight / GoldenRatioLayoutManager.GOLDEN_RATIO );
        if ( newAvailableWidth > availableWidth ) {

            throw new IllegalArgumentException(
                    "width adjustment failed:  availableWidth=" +
                    availableWidth +
                    ", availableHeight=" +
                    availableHeight +
                    ", newAvailableWidth=" +
        ...
        if ( horizontal ) {
            ...
            if ( availableHeight > newAvailableWidth ) {
                ...
                throw new IllegalArgumentException(
                        "width adjustment failed (not horizontal):  availableWidth=" +
                        availableWidth +
                        ", availableHeight=" +
                        availableHeight +
                        ", newAvailableWidth=" +
            ...
            if ( availableHeight < newAvailableWidth ) {
                ...
                throw new IllegalArgumentException(
                        "width adjustment failed (not vertical):  availableWidth=" +
                        availableWidth +
                        ", availableHeight=" +
                        availableHeight +
                        ", newAvailableWidth=" +
    ...
    private int adjustHeight(
        ...
        int newAvailableHeight = horizontal ?
                (int)Math.round( availableWidth / GoldenRatioLayoutManager.GOLDEN_RATIO ) :
                (int)Math.round( availableWidth * GoldenRatioLayoutManager.GOLDEN_RATIO );
        if ( newAvailableHeight > availableHeight ) {

            throw new IllegalArgumentException(
                    "height adjustment failed:  availableWidth=" +
                    availableWidth +
                    ", availableHeight=" +
                    availableHeight +
                    ", newAvailableHeight=" +
        ...
        if ( horizontal ) {
            ...
            if ( newAvailableHeight > availableWidth ) {
                ...
                throw new IllegalArgumentException(
                        "height adjustment failed (not horizontal):  availableWidth=" +
                        availableWidth +
                        ", availableHeight=" +
                        availableHeight +
                        ", newAvailableHeight=" +
            ...
            if ( newAvailableHeight < availableWidth ) {
                ...
                throw new IllegalArgumentException(
                        "height adjustment failed (not vertical):  availableWidth=" +
                        availableWidth +
                        ", availableHeight=" +
                        availableHeight +
                        ", newAvailableHeight=" +
