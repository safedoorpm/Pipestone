...
public abstract class JListManager implements ButtonOwner {
    ...
    public class ButtonPanel extends JPanel {
         ...
         * included in the configuration and no {@link JListManager.ListElementFactory} was specified using
         ...
         * when this {@link JListManager.ButtonPanel} instance was configured.
    ...
    /**
     * Get this instance's {@link JListManager.ButtonPanel}.
    ...
    /**
     * Get this instance's {@link JListManager.ListElementFactory}.
     * @return this instance's {@link JListManager.ListElementFactory} or null if it has not yet been set.
     */
    ...
    /**
     * Set this instance's {@link JListManager.ListElementFactory}.
     * <p/>This instance's ButttonPanel cannot be (successfully) configured if this instance's
     * {@link JListManager.ListElementFactory} is null.
     * @param listElementFactory the new value for this instance's {@link JListManager.ListElementFactory}.
     * @throws IllegalArgumentException if this method is called after this instance's ButtonPanel
    ...
    /**
     * Get this instance's {@link JListManager.UndoableListElementFactory}.
     * @return this instance's {@link JListManager.UndoableListElementFactory} or null if it has not yet been set.
     */
     ...
     * <p/>This instance's ButttonPanel cannot be (successfully) configured if this instance's
     * {@link JListManager.ListElementFactory} is null.
     * @param undoableListElementFactory the new value for this instance's {@link JListManager.ListElementFactory}.
     * @throws IllegalArgumentException if this method is called after this instance's ButtonPanel
