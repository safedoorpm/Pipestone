...
public class Pepys {
    ...
    /**
     ...
     <p/>It is possible for the sender of an event to lie about the source, source id and/or auxiliary source of an event and the type of an event for all event types other thant <code>GONE</code>.
    ...
    public abstract static class PepysEvent {
        ...
        /**
         Create an event with an event type, a source and an auxiliary source.
...
//	    }
        ...
        private PepysEvent( final long sourceId ) {
        ...
        /**
         Get this event's auxiliary source.
    ...
    public static class PepysGoneEvent extends PepysEvent {
        ...
        private PepysGoneEvent( final long sourceId ) {
    ...
    public static class ProxiedPepysEvent extends PepysEvent {
        ...
        public String toString() {
            ...
            return "ProxiedPepysEvent( eType=" +
                   getEventType() +
                   ", source=" +
                   getSource() +
                   ", pEvent=" +
    ...
    private static class PepysWeakSourceRef extends WeakReference<PepysSource> {
                        ...
                        () -> {
                            ...
                            for ( PepysEventListener listener : eligibleListeners ) {
                                ...
                                try {
                                    ...
                                    Logger.logErr(
                                            e.getClass().getSimpleName() + ":  caught handling event type " + event.getEventType() + " - " + e,
                                            e
                                    );
        ...
        @NotNull
        private List<PepysEventListener> getPepysEventListeners( final String what, final List<WeakReference<PepysEventListener>> listeners ) {
...
//			    }
    ...
    public static void fireEvent( @Nullable final PepysEvent event ) {
    ...
    public static void fireEvents( @Nullable final Collection<PepysEvent> events ) {
