...
public abstract class AbstractPackableHolder2 implements Packable2ThingHolder2 {
    ...
    @Override
    public Packable2[] PackableArrayValue() {

	return (Packable2[])getObjectValue();
    ...
    @Override
    public boolean pack( Packer2 packer2 ) {
...
//    }
    ...
    public int compareTo( @NotNull Packable2ThingHolder2 rhs ) {
	...
	return rhs instanceof Packable2ThingHolder2 && _name.equals(((Packable2ThingHolder2)rhs).getName() );
