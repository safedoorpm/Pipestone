...
//        return _string == null ? 0 : _string.hashCode();
...
//
//            return string.equals( rhs );
//
//        } else {
//
//            return rhs instanceof GowingString && string.equals( ( (GowingString)rhs ).string );
//
//        }

//        if ( rhs instanceof String ) {
//
//            return rhs.equals( _string );
//
//        } else if ( rhs instanceof GowingString ) {
//
//            if ( _string == null ) {
//
//                return ( (GowingString)rhs )._string == null;
//
//            } else {
//
//                return _string.equals( ( (GowingString)rhs )._string );
//
//            }
//
//        } else {
