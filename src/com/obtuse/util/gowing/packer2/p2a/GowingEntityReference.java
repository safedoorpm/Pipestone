...
public class GowingEntityReference implements Comparable<GowingEntityReference> {
    ...
    private final SortedSet<EntityName2> _entityReferenceNames;
...
//    private final EntityTypeName2 _typeName;
    ...
    public GowingEntityReference( int typeId, long entityId, @Nullable Integer version, @Nullable Collection<EntityName2> entityReferenceNames ) {
...
//	_typeName = typeName;
	...
	_entityReferenceNames = new TreeSet<EntityName2>();
...
//    }
    ...
    @NotNull
    public SortedSet<EntityName2> getEntityReferenceNames() {

	return Collections.unmodifiableSortedSet( _entityReferenceNames );

    }

    public static String formatNames( Collection<EntityName2> entityNames ) {

	StringBuilder sb = new StringBuilder();
	String slash = "";
	for ( EntityName2 entityName : entityNames ) {
