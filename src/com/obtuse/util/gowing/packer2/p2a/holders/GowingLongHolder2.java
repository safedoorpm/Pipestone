...
public class GowingLongHolder2 extends GowingAbstractPackableHolder2 {

    public GowingLongHolder2( @NotNull EntityName2 name, Long v, @SuppressWarnings("SameParameterValue") boolean mandatory ) {
