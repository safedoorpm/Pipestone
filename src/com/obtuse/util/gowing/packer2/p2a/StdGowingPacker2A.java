...
public class StdGowingPacker2A implements GowingPacker2 {

    private final File _outputFile;

//    private final TypeIndex2 _typeIndex;

    private final GowingPackerContext2 _packingContext;
...
//    private String _currentSeparator;
    ...
    public StdGowingPacker2A( @NotNull EntityName2 groupName, @NotNull GowingTypeIndex2 typeIndex, @NotNull File outputFile )
	    throws FileNotFoundException {
	this( groupName, outputFile, new PrintWriter( outputFile ), new StdGowingPackerContext2( typeIndex ) );

    }

    public StdGowingPacker2A(
	    @NotNull EntityName2 groupName,
	    @NotNull GowingTypeIndex2 typeIndex,
	    @NotNull File outputFile,
	    @NotNull OutputStream outputStream
    ) {
	this( groupName, outputFile, new PrintWriter( outputStream, true ), new StdGowingPackerContext2( typeIndex ) );

    }

    private StdGowingPacker2A(
	    @NotNull EntityName2 groupName,
	    @NotNull File outputFile,
	    @NotNull PrintWriter writer,
	    @NotNull GowingPackerContext2 packingContext
    ) {
...
//	_writer.print( Constants.LINE_COMMENT_CHAR );
    ...
    @NotNull
    public GowingPackerContext2 getPackingContext() {
    ...
    @Override
    public GowingInstanceId queuePackEntity( @Nullable GowingPackable2 entity ) {
    ...
    @Override
    public GowingInstanceId queuePackEntity( @Nullable EntityName2 entityName, @Nullable GowingPackable2 entity ) {
...
//	_currentSeparator = " ";
	for ( GowingPackable2ThingHolder2 thing : bundle.values() ) {
...
//	    _currentSeparator = ", ";
    ...
    private void emitEntityReference( GowingInstanceId instanceId, int version, @Nullable Collection<EntityName2> entityNames ) {
    ...
    private void emitEntityReference( int typeId, long entityId, @Nullable Integer version, @Nullable Collection<EntityName2> entityNames ) {
...
//    }
    ...
    public static class SortedSetExample extends GowingAbstractPackableEntity2 implements GowingPackable2 {
	...
	public SortedSetExample( GowingUnPacker2 unPacker, GowingPackedEntityBundle bundle ) {
	    super();
	...
	public GowingPackedEntityBundle bundleThyself( boolean isPackingSuper, GowingPacker2 packer ) {
	    ...
	    GowingPackable2Collection<String> p2c = new GowingPackable2Collection<String>( _myCollection );
	    rval.addHolder( new GowingPackableEntityHolder2( new EntityName2( "_xxx" ), p2c, packer, true ) );
	...
	public boolean finishUnpacking( GowingUnPacker2 unPacker ) {
	    ...
	    GowingPackable2Collection<String> xxx = (GowingPackable2Collection<String>) unPacker.resolveReference( _xxxReference );
	...
	BasicProgramConfigInfo.init( "Obtuse", "GowingPacker2", "test", null );

	try {

	    GowingTypeIndex2 typeIndex = new GowingTypeIndex2( "testing" );
//	    StdPackingContext2 packingContext = new StdPackingContext2( typeIndex );

	    StdGowingPacker2A p2a = new StdGowingPacker2A( new EntityName2( "test group name" ), typeIndex, new File( "test1.p2a" ) );
...
//	    pInt.pack( p2a, ", " );
	    ...
	    StdGowingPackerContext2.TestPackableClass test = new StdGowingPackerContext2.TestPackableClass( "hello world", new StdGowingPackerContext2.TestPackableClass( "inner reference", null, null ), null );
	    p2a.queuePackEntity( test );
//	    p2a.actuallyPackEntity( test.getInstanceId() );

	    test = new StdGowingPackerContext2.TestPackableClass( "howdy doody", null, new StdGowingPackerContext2.SimplePackableClass( "grump!" ) );
	    p2a.queuePackEntity( test );
	    ...
	    GowingPackable2Mapping testMapMapping = new GowingPackable2Mapping<String,EntityName2>( testMap );
	    p2a.queuePackEntity( new EntityName2( "fred" ), testMapMapping );

	    GowingPackable2Collection<Object> p2Collection = new GowingPackable2Collection<Object>();
	    p2Collection.add( "Hello" );
	    p2Collection.add( "There" );
	    GowingPackable2Collection<String> p2C2 = new GowingPackable2Collection<String>();
	    p2C2.addAll( Arrays.asList( "Mercury", "Venus", "Mars", "Jupiter" ) );
	    p2Collection.add( p2C2 );
	    p2a.queuePackEntity( new EntityName2( "fred" ), p2Collection );
	    p2a.queuePackEntity( new EntityName2( "barney" ), p2Collection );
	    p2a.queuePackEntity( new EntityName2( "betty" ), p2Collection );
	    p2a.queuePackEntity( new EntityName2( "wilma" ), p2Collection );
	    p2a.queuePackEntity( new EntityName2( "betty" ), p2Collection );
