...
public interface GowingPackable2ThingHolder2 extends Comparable<GowingPackable2ThingHolder2> {

    boolean pack( GowingPacker2 packer2 );
    ...
    GowingPackable2[] PackableArrayValue();
...
//    void emitActualValue( Packer2 packer );
    ...
    void emitRepresentation( GowingPacker2 packer2 );
