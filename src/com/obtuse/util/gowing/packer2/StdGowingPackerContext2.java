...
public class StdGowingPackerContext2 implements GowingPackerContext2 {
...
//
//	private final GowingPackingId2 _packingId;
//
//	private final GowingPackable2 _packable;
//
//	public PackingAssociation( GowingInstanceId instanceId, GowingPackingId2 packingId, GowingPackable2 packable ) {
//	    super();
//
...
//
//	@NotNull
//	public GowingPackable2 getPackable() {
//
//	    return _packable;
//
//	}
...
//    }
    ...
    public StdGowingPackerContext2( @NotNull GowingTypeIndex2 typeIndex ) {
	super();
...
//    }
    ...
    @Override
    public void rememberPackableEntity( EntityName2 entityName, GowingPackable2 entity ) {
...
//	}
	...
	if ( !_seenInstanceIds.containsKey( entity.getInstanceId() ) ) {
	    ...
	    _seenInstanceIds.put( entity.getInstanceId(), new EntityNames( new LinkedList<EntityName2>(), entity ) );
...
//    }
    ...
    public static class TestPackableClass extends GowingAbstractPackableEntity2 implements GowingPackable2 {

	private static final EntityTypeName2 ENTITY_TYPE_NAME = new EntityTypeName2( StdGowingPackerContext2.TestPackableClass.class );
...
//	    context.registerFactory( FACTORY );
	...
	public TestPackableClass( GowingUnPacker2 unPacker, GowingPackedEntityBundle bundle, GowingEntityReference er ) {
	    super();
...
//		    super.bundleThyself( true, packer ),
	    ...
	    rval.addHolder( new GowingPackableEntityHolder2( new EntityName2( "_simple" ), _simple, packer, false ) );
	    rval.addHolder( new GowingPackableEntityHolder2( new EntityName2( "_inner" ), _inner, packer, false ) );
	    rval.addHolder( new GowingStringHolder2( new EntityName2( "_payload" ), _payload, true ) );
	    rval.addHolder( new GowingIntegerHolder2( new EntityName2( "_iValue" ), _iValue, false ) );
	    rval.addHolder( new GowingBooleanHolder2( new EntityName2( "_booleanValue" ), true, true ) );
	    rval.addHolder( new GowingDoubleHolder2( new EntityName2( "_doubleValue" ), Math.PI, false ) );
	    rval.addHolder( new GowingFloatHolder2( new EntityName2( "_floatValue" ), 1.1f, true ) );
	    rval.addHolder( new GowingShortHolder2( new EntityName2( "_shortValue" ), (short) 15, false ) );
	    rval.addHolder( new GowingLongHolder2( new EntityName2( "_longValue" ), 123L, true ) );
    ...
    public static class SimplePackableClass extends GowingAbstractPackableEntity2 implements GowingPackable2 {

	private static final EntityTypeName2 ENTITY_TYPE_NAME = new EntityTypeName2( StdGowingPackerContext2.SimplePackableClass.class );
...
//	    context.registerFactory( FACTORY );
	...
	public SimplePackableClass( GowingUnPacker2 unPacker, GowingPackedEntityBundle bundle, GowingEntityReference er ) {
	    super();
	...
	public GowingPackedEntityBundle bundleThyself( boolean isPackingSuper, GowingPacker2 packer ) {
	    ...
	    rval.addHolder( new GowingStringHolder2( new EntityName2( "_thing" ), _payload, true ) );
