...
/**
 Mark a class which might be derived from something which is {@link GowingBackReferenceable}
 but which is not actually back-referenceable.
 <p>This is intended for classes which are derived from {@link GowingBackReferenceable}
