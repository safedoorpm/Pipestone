...
public interface UniqueLongIdGenerator {
    ...
    UniqueLongIdGenerator setLastId( long lastId );
     ...
     * Implementations should be capable of returning at least 2<sup>48</sup> distinct ids before returning a duplicate becomes possible (this truly
