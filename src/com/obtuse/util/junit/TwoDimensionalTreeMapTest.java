...
public class TwoDimensionalTreeMapTest {

    private TwoDimensionalTreeMap<Integer, Integer, String> _map;
    ...
    public void testConstructor() {
        ...
        Assert.assertNull( _map.get( 1, 2 ) );
    ...
    public void testGetPut() {
        ...
        Assert.assertEquals( "Hello", _map.get( 1, 2 ) );
    ...
    public void testGetInnerMap() {
        ...
        SortedMap<Integer, String> innerMap1 = _map.getInnerMap( 1, true );
        ...
        SortedMap<Integer, String> removedInnerMap = _map.removeInnerMap( 1 );
        ...
        Assert.assertEquals( "Hello", innerMap1.get( 2 ) );
        ...
        Assert.assertEquals( 2, _map.size() );
        Assert.assertEquals( "Hello", _map.get( 1, 2 ) );
        Assert.assertEquals( "World", _map.get( 1, 99 ) );
        ...
        Assert.assertEquals( "Hello", innerMap1.get( 2 ) );
        Assert.assertEquals( "World", innerMap1.get( 99 ) );
        ...
        SortedMap<Integer, String> innerMap2 = _map.getInnerMap( 99, false );

        Assert.assertNotNull( innerMap2 );

        Assert.assertEquals( 1, innerMap2.size() );
        Assert.assertEquals( "There", innerMap2.get( 2 ) );
        Assert.assertEquals( "Hello", innerMap1.get( 2 ) );
        Assert.assertEquals( 3, _map.size() );

        // Verify that deleting the things in the map does not delete the inner maps

        Assert.assertEquals( "Hello", _map.remove( 1, 2 ) );
        Assert.assertEquals( 2, _map.size() );
        Assert.assertEquals( "World", _map.remove( 1, 99 ) );
        Assert.assertEquals( 1, _map.size() );
        Assert.assertEquals( "There", _map.remove( 99, 2 ) );
        Assert.assertEquals( 0, _map.size() );
        Assert.assertSame( innerMap1, _map.getInnerMap( 1, false ) );
    ...
    public void testRemoveInner() {
        ...
        SortedMap<Integer, String> innerMap2 = _map.getInnerMap( 99, true );
        ...
        Assert.assertEquals( "Hello", _map.get( 1, 2 ) );
        Assert.assertEquals( "World", _map.get( 99, 2 ) );
        Assert.assertNotNull( innerMap1 );
        Assert.assertSame( innerMap1, _map.getInnerMap( 1, false ) );
        Assert.assertEquals( 1, innerMap1.size() );
        Assert.assertEquals( "Hello", innerMap1.get( 2 ) );
        ...
        Assert.assertSame( innerMap2, _map.getInnerMap( 99, false ) );
        Assert.assertEquals( 1, innerMap2.size() );
        Assert.assertEquals( "World", innerMap2.get( 2 ) );
        Assert.assertEquals( 2, _map.outerKeys().size() );
        Assert.assertEquals( 2, _map.size() );

        // Remove the first inner map

        SortedMap<Integer, String> removedInnerMap1 = _map.removeInnerMap( 1 );
        ...
        Assert.assertNull( _map.getInnerMap( 1, false ) );
        Assert.assertNull( "Hello", _map.get( 1, 2 ) );
        Assert.assertEquals( "World", _map.get( 99, 2 ) );
        Assert.assertEquals( "Hello", removedInnerMap1.get( 2 ) );
        Assert.assertEquals( 1, _map.outerKeys().size() );
        Assert.assertEquals( 1, _map.size() );

        // Remove the second inner map

        SortedMap<Integer, String> removedInnerMap2 = _map.removeInnerMap( 99 );
        ...
        Assert.assertNull( "World", _map.get( 99, 2 ) );
        Assert.assertEquals( "World", removedInnerMap2.get( 2 ) );
        Assert.assertEquals( 0, _map.outerKeys().size() );
        Assert.assertEquals( 0, _map.size() );
    ...
    public void testRemove() {
        ...
        Assert.assertNull( _map.remove( 1, 2 ) );
        Assert.assertEquals( 0, _map.size() );
        ...
        SortedMap<Integer, String> innerMap1 = _map.getInnerMap( 1, false );
        Assert.assertEquals( 1, _map.outerKeys().size() );

        // Verify that it is there and that it goes away when removed.

        Assert.assertEquals( "World", _map.get( 1, 2 ) );
        Assert.assertEquals( "World", _map.remove( 1, 2 ) );
        Assert.assertNull( _map.get( 1, 2 ) );
        ...
        SortedMap<Integer, String> innerMap2 = null;
        for ( int i = 0; i < 2; i += 1 ) {
            ...
            try {
                ...
                Assert.assertNotNull( innerMap2 );
                Assert.assertEquals( "Hello", _map.get( 1, 99 ) );
                Assert.assertEquals( "There", _map.get( 99, 4 ) );
                Assert.assertEquals( "Hello", innerMap1.get( 99 ) );
                Assert.assertNull( innerMap1.get( 4 ) );
                Assert.assertEquals( "There", innerMap2.get( 4 ) );
                Assert.assertNull( innerMap2.get( 99 ) );

                // Remove something that isn't there

                Assert.assertNull( _map.remove( 1, 1 ) );
        ...
        Assert.assertEquals( 1, _map.size() );
        Assert.assertEquals( "Hello", hello );
        Assert.assertNull( _map.get( 1, 99 ) );
        Assert.assertNotNull( innerMap1 );
        Assert.assertNotNull( innerMap2 );
        Assert.assertSame( innerMap1, _map.getInnerMap( 1, false ) );
        Assert.assertSame( innerMap2, _map.getInnerMap( 99, false ) );
        Assert.assertNull( innerMap1.get( 99 ) );
        Assert.assertEquals( 0, innerMap1.size() );
        Assert.assertEquals( 1, innerMap2.size() );
        Assert.assertEquals( "There", _map.get( 99, 4 ) );
        SortedMap<Integer, String> innerMap99 = _map.getInnerMap( 99, false );
        Assert.assertNotNull( innerMap99 );
        Assert.assertEquals( "There", innerMap99.get( 4 ) );

        // Remove the second of the two things

        String there = _map.remove( 99, 4 );
        ...
        Assert.assertSame( innerMap2, _map.getInnerMap( 99, false ) );
        Assert.assertNull( innerMap1.get( 99 ) );
        Assert.assertNull( innerMap2.get( 4 ) );
        Assert.assertEquals( 0, innerMap1.size() );
        Assert.assertEquals( 0, innerMap2.size() );
    ...
    public void testOuterKeys() {
        ...
        SortedMap<Integer, String> innerMap2 = _map.getInnerMap( 2, true );
        ...
        _map.put( 3, 1, "There" );
        SortedMap<Integer, String> innerMap3 = _map.getInnerMap( 3, false );
        ...
        SortedMap<Integer, String> innerMap1a = _map.removeInnerMap( 1 );
    ...
    public void testIterator() {
        ...
        TreeCounter<String> countedValues = TwoDimensionalTreeMapTest.getTreeCountedContents( _map );
    ...
    public void testToString() {
        ...
        Assert.assertEquals( "TwoDimensionalTreeMap( size = 0 )", _map.toString() );
        ...
        Assert.assertEquals( "TwoDimensionalTreeMap( size = 2 )", _map.toString() );

    }

    private static Vector<String> getContents( final TwoDimensionalSortedMap<Integer,Integer,String> map ) {
    ...
    private static SortedMap<Integer,String> getSortedContents( final TwoDimensionalSortedMap<Integer,Integer,String> map ) {
    ...
    private static TreeCounter<String> getTreeCountedContents( final TwoDimensionalSortedMap<Integer,Integer,String> map ) {
