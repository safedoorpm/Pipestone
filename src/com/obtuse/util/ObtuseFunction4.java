...
/**
 A variant of {@link java.util.function.Function} that takes four arguments.
...
public interface ObtuseFunction4<K1, K2, K3, K4, R> {
    ...
    R apply( K1 key1, K2 key2, K3 key3, K4 key4 );
